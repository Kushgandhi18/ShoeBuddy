import 'package:shoebuddy/firebase/authentication_services.dart';
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              SizedBox(height: 50),
              Text('ShoeBuddy,' , style: TextStyle(color: color2 , fontWeight: FontWeight.w500 , fontSize: 28),),
              Text(' Welcome\'s You...' , style: TextStyle( fontSize: 26),),
              SizedBox(height: 120),
              Text('"Find Your Perfect Pair at Shoe Buddy - Where Fashion Begins."' , textAlign: TextAlign.center,style: TextStyle(),),
